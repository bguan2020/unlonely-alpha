            ...
            <Flex width="100%" justifyContent="center" direction="column">
              ...
              >
                ...
                <Text mt="2rem">
                  ...
                  continued use of this App after we revise this policy means
                  you accept those changes, so please check the policy
                  periodically for updates.
                </Text>
                <Text mt="2rem">
                  Information We Collect and How We Collect It We collect
                  information from and about users of our App: Directly from you
                  when you provide it to us. Automatically when you use the App.
                  Information You Provide to Us When you download, register
                  with, or use this App, we may ask you provide information by
                  which you may be personally identified, such as name, email
                  address, telephone number, or any other identifier by which
                  you may be contacted online or offline ("Personal
                  Information").
                </Text>
                <Text mt="2rem">
                  This information includes: Information provided at the time of
                  registering to use the App, subscribing to our service, and
                  posting material, and requesting further services. Records and
                  copies of your correspondence (including email addresses and
                  phone numbers) if you contact us. You may also provide
                  information for publication or display ("Posted") on areas of
                  the app (collectively, "User Contributions"). Your User
                  Contributions are Posted and transmitted to others at your own
                  risk. Additionally, we cannot control the actions of third
                  parties with whom you may choose to share your User
                ...
                <Text mt="2rem">
                  ...
                  information, to: Provide you with the App and its contents,
                  and any other information, products, or services that you
                  request from us. Fulfill any other purpose for which you
                  provide it. Give you notices about your account. Carry out our
                  obligations and enforce our rights arising from any contracts
                  entered into between you and us. Disclosure of Your
                  Information We may disclose aggregated information about our
                  users, and information that does not identify any individual
                  or device, without restriction.
                </Text>
                <Text mt="2rem">
                  In addition, we may disclose personal information that we
                  collect or you provide: To our subsidiaries and affiliates. To
                  ...
                  other sale or transfer of some or all of Nuanced Labs, Inc.'s
                  assets, whether as a going concern or as part of bankruptcy,
                  liquidation, or similar proceeding, in which personal
                  information held by Nuanced Labs, Inc. about our App users is
                  ...
                  court order, law, or legal process, including to respond to
                  any government or regulatory request. To enforce our rights
                  ...
                  the rights, property, or safety of Nuanced Labs Inc., our
                  customers or others. This includes exchanging information with
                  other companies and organizations for the purposes of fraud
                  protection and credit risk reduction. Accessing and Correcting
                  Your Personal Information You can review and change your
                  personal information by logging into the App and visiting your
                  account profile page.
                </Text>
                <Text mt="2rem">
                  We cannot delete your personal information except by also
                  deleting your user account. We may not accommodate a request
                  to change information if we believe the change would violate
                ...
                <Text mt="2rem">
                  ...
                  App users. Proper access and use of information provided on
                  the App, including User Contributions, is governed by our
                  terms of use.
                </Text>
                <Text mt="2rem">
                  Your California Privacy Rights If you are a California
                  resident, California law may provide you with additional
                  rights regarding our use of your personal information. To
                ...
                <Text mt="2rem">
                  ...
                  an email to legal@honk.me or write us at: 1150 Foothill Blvd #
                  D, La Cañada Flintridge, CA 91011
                </Text>
                <Text mt="2rem">
                  Data Security We have implemented measures designed to secure
                  ...
                  behind firewalls. Any personal information will be encrypted
                ...
                <Text mt="2rem">
                  ...
                  App. The information you share in public areas may be viewed
                ...
                <Text mt="2rem">
                  ...
                  circumvention of any privacy settings or security measures we
                  provide.
                </Text>
                <Text mt="2rem">
                  Changes to Our Privacy Policy We may update our privacy policy
                  from time to time. If we make material changes to how we treat
                  our users' personal information, we will post the new privacy
                  policy on this page with a notice that the privacy policy has
                  been updated. The date the privacy policy was last revised is
                  identified at the top of the page. You are responsible for
                  ensuring we have an up-to-date active and deliverable contact
                  information for you and for periodically visiting this privacy
