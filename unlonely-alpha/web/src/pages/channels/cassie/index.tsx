...
const playbackUrl =
  "https://0ef8576db087.us-west-2.playback.live-video.net/api/video/v1/us-west-2.500434899882.channel.mfG3fmtJ3ti0.m3u8";

const channelArn = "arn:aws:ivs:us-west-2:500434899882:channel/mfG3fmtJ3ti0";
const ablyChatChannel = "cassie-channel";
const ablyPresenceChannel = "cassie-presence-channel";
