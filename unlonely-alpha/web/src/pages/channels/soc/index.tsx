...
const seamPlaybackUrl =
  "https://0ef8576db087.us-west-2.playback.live-video.net/api/video/v1/us-west-2.500434899882.channel.5cpf77eXSWMV.m3u8";

const channelArn = "arn:aws:ivs:us-west-2:500434899882:channel/5cpf77eXSWMV";
const ablyChatChannel = "soc-channel";
const ablyPresenceChannel = "soc-presence-channel";
        ...
        <Flex direction="column">
          ...
          >
            <Text fontSize="2rem" fontWeight="bold">
              The Stream of Consciousness Channel
            </Text>
          </Flex>
