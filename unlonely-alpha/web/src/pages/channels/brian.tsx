...
const Example: React.FunctionComponent<Props> = ({ hostEvents, loading }) => {
  ...
  const [isTheatreMode, setIsTheatreMode] = useState<boolean>(router.query.theatreMode === "true");
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Flex maxH="400px" margin="auto" mb="16px" ml="32px" w="100%" justifyContent="space-between" pr="32px">
