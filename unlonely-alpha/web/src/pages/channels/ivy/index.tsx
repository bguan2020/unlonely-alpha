...
const lesgreysPlaybackUrl =
  "https://0ef8576db087.us-west-2.playback.live-video.net/api/video/v1/us-west-2.500434899882.channel.XWtnI0HfH8NB.m3u8";

const channelArn = "arn:aws:ivs:us-west-2:500434899882:channel/XWtnI0HfH8NB";
const ablyChatChannel = "ivy-channel";
const ablyPresenceChannel = "ivy-presence-channel";
