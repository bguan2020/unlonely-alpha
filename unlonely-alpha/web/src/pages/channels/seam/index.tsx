...
const seamPlaybackUrl =
  "https://0ef8576db087.us-west-2.playback.live-video.net/api/video/v1/us-west-2.500434899882.channel.1teZ89zyzUEm.m3u8";

const channelArn = "arn:aws:ivs:us-west-2:500434899882:channel/1teZ89zyzUEm";
const ablyChatChannel = "seam-channel";
const ablyPresenceChannel = "seam-presence-channel";
