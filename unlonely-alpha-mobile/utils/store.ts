...
// refactor this to different stores:
// 1. BottomSheetStore: settings, connectkit, nfc modal
// 2. AppSettings: nfc feed sorting, blur, nfc autoplay
// 3. UserStore: user data, connected wallet, notification settings & tokens
// 4. VideoPlayerStore: nfc player state, live stream player state, volume settings

// do not render settings bottom sheet unless the flag for it is enabled/open
...
//   persist(
//     set => ({
//       isCKSheetOpen: false, // should not be persisted
